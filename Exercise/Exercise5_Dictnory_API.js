console.log('Exercise 5 Dictnory API');

// use a ord api which will contain a object you have print all teh result of the word api. and print in the dom

// take input from the input tag

// Because i dont have a key, so copied the json file from the wordapi, if i had i can use fetch api
